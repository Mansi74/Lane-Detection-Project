...
class LaneLines:
    ...
    def fit_poly(self, img):
        ...
        for i, y in enumerate(ploty):
            ...
            r = int(right_fitx[i])
            y = int(y)
            cv2.line(out_img, (l, y), (r, y), (0, 0, 255))
    ...
    def plot(self, out_img):
        ...
        curvature_msg = "Radius of curvature = {:.0f} m".format(min(lR, rR))
        if direction in 'LR':
           cv2.putText(out_img, curvature_msg, org=(10, 40), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(255, 255, 255), thickness=2)
